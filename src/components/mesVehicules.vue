<template>
    <div class="all">
        ...
        <div class="container">
            ...
            <div>
                <h1 style="margin-top: 80px; color: #e4510c;">Mes véhicules</h1>
                ...
                <div v-else- class="vList" style="margin-top: 40px;">
                    <router-link v-for="vehicle in vehicles" :key="vehicle.id" :to="'/detailsVehicule/' + vehicle._id"
                        ...
                        <div style="padding: 0; border-bottom: 1px solid rgba(0, 0, 0, 0.1);">
                            <h4 style="color: #e4510cc9;">{{ vehicle.marque.libelle }} {{ vehicle.model.libelle }}</h4>
                            <h5 style="margin-top: -20px; color: #e4510c;">{{ totalDepenses }} FCFA ce mois
                            </h5>
                        </div>
                        <div style="display: flex; justify-content: space-between; padding: 10px 0;">
                            <span style="color: #e4510cc9;">4 réparations </span>
                            <span style="color: #e4510cc9;">3 chargements</span>
                        </div>
                    </router-link>
